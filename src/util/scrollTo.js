...
export const scrollTo = (anchorId = null, doScroll = false, timer = 0) => {
    if (doScroll) {
        ...
        if (!scrollOnce) {
            ...
            let anchor = element
                ? element.getBoundingClientRect().y - document.body.getBoundingClientRect().y + window.innerWidth < parseInt(variable.md, 10)
                    ? 0
                    : 80
                : 0;
